...
val COMMENT_ENTRIES_IBFK_1: ForeignKey<CommentEntriesRecord, JournalsRecord> = Internal.createForeignKey(CommentEntries.COMMENT_ENTRIES, DSL.name("comment_entries_ibfk_1"), arrayOf(CommentEntries.COMMENT_ENTRIES.JOURNAL_ID), com.okeicalm.simpleJournalEntry.infra.db.keys.KEY_JOURNALS_PRIMARY, arrayOf(Journals.JOURNALS.ID), true)
val COMMENT_ENTRIES_IBFK_2: ForeignKey<CommentEntriesRecord, AccountsRecord> = Internal.createForeignKey(CommentEntries.COMMENT_ENTRIES, DSL.name("comment_entries_ibfk_2"), arrayOf(CommentEntries.COMMENT_ENTRIES.ACCOUNT_ID), com.okeicalm.simpleJournalEntry.infra.db.keys.KEY_ACCOUNTS_PRIMARY, arrayOf(Accounts.ACCOUNTS.ID), true)
val COMMENT_ENTRIES_IBFK_3: ForeignKey<CommentEntriesRecord, CommentsRecord> = Internal.createForeignKey(CommentEntries.COMMENT_ENTRIES, DSL.name("comment_entries_ibfk_3"), arrayOf(CommentEntries.COMMENT_ENTRIES.COMMENT_ID), com.okeicalm.simpleJournalEntry.infra.db.keys.KEY_COMMENTS_PRIMARY, arrayOf(Comments.COMMENTS.ID), true)
